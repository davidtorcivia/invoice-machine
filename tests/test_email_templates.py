...
from invoicely.database import Base, BusinessProfile, Client, Invoice
from invoicely.email import (
    expand_template,
...
async def api_client():
    ...
    async with invoicely.database.async_session_maker() as session:
        from invoicely.database import User
...
class TestEmailTemplateMCPTools:
    ...
    async def test_mcp_get_templates_structure(self, db_session, business_profile):
        ...
        from invoicely.mcp.server import get_email_templates
    ...
    async def test_mcp_update_subject_template(self, db_session, business_profile):
        ...
        from invoicely.mcp.server import update_email_templates, get_email_templates
    ...
    async def test_mcp_update_body_template(self, db_session, business_profile):
        ...
        from invoicely.mcp.server import update_email_templates
    ...
    async def test_mcp_preview_with_defaults(
        ...
        from invoicely.mcp.server import preview_invoice_email
