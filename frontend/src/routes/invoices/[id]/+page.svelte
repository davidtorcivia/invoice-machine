  ...
  {:else if invoice}
    <div class="page-header">
      ...
      <div class="page-actions">
        ...
        <button class="btn btn-secondary" on:click={openSendEmailModal}>
  ...
  <div class="modal-overlay" on:click={cancelSendEmail} on:keydown={(e) => e.key === 'Escape' && cancelSendEmail()}>
    <div class="modal-content email-modal" on:click|stopPropagation role="dialog" aria-modal="true">
      <div class="modal-header">
        ...
        <button class="btn btn-ghost btn-sm" on:click={cancelSendEmail}>
          <Icon name="x" size="sm" />
        </button>
      </div>
      ...
      {:else}
        ...
        <div class="modal-actions">
          <button class="btn btn-ghost" on:click={cancelSendEmail}>
            Cancel
          </button>
          <button
            class="btn btn-primary"
            on:click={confirmSendEmail}
