...
class BackupService:
    ...
    def create_backup(self, compress: bool = True) -> dict:
        ...
        if compress:
            backup_filename = f"invoice_machine_backup_{timestamp_str}.db.gz"
        else:
            backup_filename = f"invoice_machine_backup_{timestamp_str}.db"
    ...
    def list_backups(self) -> list[dict]:
        ...
        backups = []
        # List both new and old prefix backups for backwards compatibility
    ...
    def list_s3_backups(self) -> list[dict]:
        ...
        try:
            ...
            for obj in response.get("Contents", []):
                ...
                # Support both new and old backup prefixes for backwards compatibility
                if filename.startswith("invoice_machine_backup_") or filename.startswith("invoicely_backup_"):
                    backups.append({
                        "filename": filename,
                        "size_bytes": obj["Size"],
