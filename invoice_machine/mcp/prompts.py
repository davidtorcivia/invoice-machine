...
def chase_overdue() -> str:
    ...
    return (
        ...
        "3. For anything more than a week overdue, preview the chase email "
        "with preview_invoice_email and show it to me.\n\n"
        "Do not send anything. Show me the list and the drafts, and I will "
