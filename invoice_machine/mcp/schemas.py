...
class InvoiceOut(_Out):
    ...
    amount_outstanding: str | None = None
    amount_refunded: str | None = None
    amount_pending: str | None = None
    ...
    payment_link_configured: bool | None = None
...
class PaymentOut(_Out):
    """A payment ledger entry, with provider credentials already stripped."""
