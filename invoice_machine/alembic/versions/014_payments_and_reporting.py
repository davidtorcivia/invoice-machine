...
def upgrade() -> None:
    ...
    new_invoice_columns = [
        ("amount_paid", sa.Column("amount_paid", sa.DECIMAL(10, 2), nullable=False, server_default="0")),
        ...
        ("converted_from_invoice_id", sa.Column("converted_from_invoice_id", sa.Integer(), nullable=True)),
        ("converted_to_invoice_id", sa.Column("converted_to_invoice_id", sa.Integer(), nullable=True)),
        ...
        ("payment_link_created_at", sa.Column("payment_link_created_at", sa.DateTime(), nullable=True)),
    ]
    ...
    new_profile_columns = [
        ("reminders_enabled", sa.Column("reminders_enabled", sa.Integer(), nullable=False, server_default="0")),
        ...
        ("reminder_subject_template", sa.Column("reminder_subject_template", sa.String(500), nullable=True)),
        ("reminder_body_template", sa.Column("reminder_body_template", sa.Text(), nullable=True)),
        ("payments_enabled", sa.Column("payments_enabled", sa.Integer(), nullable=False, server_default="0")),
        ...
        ("stripe_webhook_secret", sa.Column("stripe_webhook_secret", sa.String(500), nullable=True)),
