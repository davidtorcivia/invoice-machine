...
Run with: python -m invoice_machine.migrations.add_new_fields
"""
...
DEFAULT_DB_PATH = Path(__file__).parent.parent.parent / "data" / "invoice_machine.db"
...
def migrate(db_path: Path = DEFAULT_DB_PATH):
    ...
    migrations = [
        ...
        ("business_profile", "mcp_api_key", "VARCHAR(128)"),
        ("business_profile", "bot_api_key", "VARCHAR(128)"),
        ...
        ("business_profile", "smtp_password", "VARCHAR(500)"),
